...
public class SPLogger extends MarkerIgnoringBase{
	 ...
	 private static final long serialVersionUID = -632788891211436180L;
	    ...
	    public static final String SYSTEM_PREFIX = "org.slf4j.impl.SPLogger.";
	    ...
	    void write(StringBuilder buf, Throwable t) {
	    	...
	    	try
	    	{
	    		System.out.println("Using SP Logging");
	    		if(buf.toString().contains("ERROR"))
	    			TARGET_STREAM = System.err;
	    		else
